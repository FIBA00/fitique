		...
		<div>
				...
				<div className="flex flex-col justify-between bg-fitique-paper px-6 py-10 sm:px-10 lg:py-14">
					<div>
						...
						<p className="mt-6 max-w-sm text-sm leading-7 text-fitique-ink/70">
							Boutique pieces, considered pairings, and a
							fit-check experience designed to make the decision
							feel easier.
						</p>
					</div>
					...
					<div className="mt-12 grid grid-cols-3 border-t border-fitique-line pt-5 text-[.66rem] font-extrabold uppercase tracking-widest text-fitique-ink/60">
						<span>Curated edit</span>
						<span>Easy returns</span>
						<span>Delivered to you</span>
					</div>
				</div>
				<div className="relative min-h-116 overflow-hidden bg-fitique-sand sm:min-h-144">
					<img
					...
					/>
					<div className="absolute inset-x-0 bottom-0 flex items-end justify-between bg-linear-to-t from-fitique-ink/70 via-fitique-ink/20 to-transparent p-5 sm:p-7">
			...
			<section className="my-4 bg-fitique-lilac/55 py-12 lg:my-10 lg:py-20">
				<div className="content-shell grid gap-8 lg:grid-cols-[1fr_.9fr] lg:items-center">
					<div className="relative min-h-100 overflow-hidden bg-fitique-paper">
						<img
							...
							className="absolute inset-0 h-full w-full object-cover"
						/>
						<div className="absolute bottom-5 left-5 max-w-60 bg-fitique-ivory/95 p-4 soft-shadow">
							<p className="eyebrow text-fitique-brown">
								A considered recommendation
							</p>
							<p className="serif mt-2 text-xl text-fitique-plum">
								Your measurements, your style, a clearer next
								step.
							</p>
						</div>
					</div>
					<div className="px-1 lg:px-10">
						...
						<p className="mt-5 max-w-lg text-sm leading-7 text-fitique-ink/70">
							Share a photo, choose the piece you are considering,
							then explore a guided size and outfit
							recommendation. This MVP demonstrates the experience
							using sample guidance.
						</p>
						...
						<Link
							to="/fit-check"
							className="plum-button focus-ring mt-8">
				...
				<div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
					{(categories || []).map((category, index) => (
						<Link
							...
							className={`focus-ring group relative min-h-60 overflow-hidden bg-fitique-paper ${index === 0 ? "sm:col-span-2 lg:col-span-1" : ""}`}>
							<img
								src={category.image}
								alt=""
								loading="lazy"
							...
							/>
							<div className="absolute inset-0 bg-linear-to-t from-fitique-ink/80 via-fitique-ink/10 to-transparent" />
			...
			<section className="bg-fitique-paper py-12 lg:py-20">
				<div className="content-shell">
					...
					<div className="mt-9 grid gap-6 lg:grid-cols-[1.1fr_.9fr]">
						<div className="relative min-h-104 overflow-hidden">
							<img
				...
				{[
					...
					<div key={title} className="bg-fitique-ivory px-6 py-7">
						<Icon
							...
							className="text-fitique-plum"
						/>
						<p className="serif mt-5 text-2xl text-fitique-plum">
							{title}
						</p>
