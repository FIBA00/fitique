    ...
    <div className="content-shell py-6 lg:py-10">
      ...
      {searchParams.get("new") && (
        <div className="mt-5 border border-[#bdd5c0] bg-[#edf6ee] p-4 text-sm text-[#315d37]">
          <span className="font-extrabold">Your order is confirmed.</span> Your
          selected delivery alert channels are ready for provider connection.
        </div>
      )}
      <div className="mt-6 grid gap-8 lg:grid-cols-[1fr_22rem]">
        <section>
          <div className="border-b border-fitique-line pb-6">
            <p className="eyebrow text-fitique-brown">Order {order.id}</p>
          ...
          <section className="mt-7 bg-fitique-paper p-5">
            <div className="flex gap-3">
              <Truck size={20} className="shrink-0 text-fitique-plum" />
              <div>
                <p className="font-extrabold">{order.delivery.method}</p>
          ...
          <section className="mt-8">
            <p className="eyebrow text-fitique-brown">Pieces in this order</p>
          ...
          <section className="bg-fitique-paper p-5">
            ...
            <dl className="mt-5 grid gap-3 text-sm">
              <div className="flex justify-between">
                <dt className="text-fitique-ink/65">Order placed</dt>
                <dd>{order.date}</dd>
              </div>
              <div className="flex justify-between">
            ...
            <div className="mt-6 border-t border-fitique-line pt-5">
              <p className="flex items-center gap-2 text-sm font-bold">
                <MapPin size={16} className="text-fitique-plum" /> Delivery
                notes
              </p>
              <p className="mt-2 text-xs leading-5 text-fitique-ink/60">
                You can return a piece that does not feel right after you have
                tried it at home.
              </p>
            </div>
          </section>
