...
export default function Checkout() {
  ...
  function placeOrder(values) {
    mutation.mutate({
      ...
      items: items.map(({ id, name, image, size, color, quantity, price }) => ({
        productId: id,
        name,
        image,
        size,
      ...
      <div className="mt-6 grid gap-10 lg:grid-cols-[1fr_22rem]">
        ...
        >
          <div className="border-b border-fitique-line pb-6">
            <p className="eyebrow text-fitique-brown">A few details</p>
          ...
          <section className="border-t border-fitique-line pt-7">
            ...
            <div className="grid gap-3">
              {["Boutique delivery", "Collection point"].map((method) => (
                <label
                  key={method}
          ...
          {mutation.isError && (
            ...
            >
              We could not prepare your secure payment step. Please review your
              ...
              >
                ...
                >
                  ...
                  <p className="mt-2 max-w-xs text-sm leading-6 text-fitique-ink/65">
                    Your selected method is being prepared for a secure payment
                    handoff.
                  </p>
                </motion.div>
              </motion.div>
        ...
        <aside className="h-fit bg-fitique-paper p-5 lg:sticky lg:top-24">
          ...
          <p className="mt-5 flex gap-2 text-xs leading-5 text-fitique-ink/55">
            ...
            />{" "}
            Fitique carries your preferred payment path to the secure provider
            step without collecting payment details.
          </p>
        </aside>
      </div>
    </div>
