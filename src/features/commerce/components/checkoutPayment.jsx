	...
	return (
		<section className="border-t border-fitique-line pt-7">
			<div className="mb-4 flex items-start justify-between gap-4">
				<div>
					...
					<p className="mt-2 text-sm text-fitique-ink/65">
						Choose the payment path that suits you. Your secure next
						step will appear after order review.
					</p>
				</div>
			...
			<p className="mt-4 flex gap-2 border-l-2 border-fitique-brown bg-fitique-paper px-3 py-2 text-xs leading-5 text-fitique-ink/65">
				<BadgeInfo
					size={15}
					className="mt-0.5 shrink-0 text-fitique-brown"
				/>{" "}
				<span>
					<strong className="text-fitique-ink">A calm note:</strong>{" "}
					payment details are never entered into Fitique. Your chosen
					provider will present its own secure page or embedded fields
					at the next step.
				</span>
			</p>
		</section>
