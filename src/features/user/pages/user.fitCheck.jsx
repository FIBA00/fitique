...
export default function FitCheck() {
  ...
  const saveProfile = trpc.fitCheck.saveProfile.useMutation({
    onSuccess: (profile) => {
      if (profile?.preferredSize)
        localStorage.setItem("fitique-preferred-size", profile.preferredSize);
  ...
  const analyzeMutation = trpc.fitCheck.analyze.useMutation({
    ...
    onError: (error) => {
      setStep(3);
      toast.error(error.message || "We could not complete your Fit Check.");
    },
  });
      ...
      <div className="content-shell py-7 lg:py-10">
          ...
          <div className="paper-noise relative overflow-hidden border border-fitique-line bg-fitique-lilac/70 p-5">
            ...
            <div className="mt-14 border-t border-fitique-plum/30 pt-3">
              ...
              <p className="serif mt-2 text-2xl leading-6 text-fitique-plum">
                Take your time. The right feeling is part of the fit.
              </p>
            </div>
          </div>
          <div className="max-w-3xl lg:px-6">
            <p className="eyebrow text-fitique-brown">Live personal guidance</p>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-fitique-ink/65">
              A private, image-led estimate for your next piece. Your saved
              profile makes the guidance more personal each time.
            </p>
            {!isAuthenticated && (
              <button
                onClick={startLogin}
            ...
            {isAuthenticated && (
              <div className="mt-5 flex flex-wrap items-center gap-x-4 gap-y-2">
                <p className="text-xs font-bold text-fitique-brown">
                  Signed in as {user?.name || "Fitique member"}
                </p>
                <Link
                  to="/fit-history"
        ...
        <div className="mt-7 grid grid-cols-4 border-y border-fitique-line py-4">
          {steps.map((label, index) => {
            const active = step === index + 1 || (index === 3 && step === 5);
        ...
        <div className="mt-8 min-h-124 border border-fitique-line bg-fitique-ivory p-5 sm:p-8 lg:p-10">
          {step === 1 && (
            <section className="mx-auto max-w-xl">
              <p className="eyebrow text-fitique-brown">Step 01</p>
              <h2 className="serif mt-2 text-4xl text-fitique-plum">
                Start with a photo.
              </h2>
              <p className="mt-3 text-sm leading-6 text-fitique-ink/65">
                Use a clear, full-length photo in everyday clothes. Fitique
                turns that visual context and the piece you choose into a
                conservative style-and-size estimate.
              </p>
              <p className="mt-5 border-l-2 border-fitique-plum bg-fitique-lilac/50 px-4 py-3 text-xs leading-5 text-fitique-ink/70">
                ...
                this photo is securely sent for Fit Check analysis and saved
                with your private result so you can revisit it from your
                account.
              </p>
              {previewUrl ? (
                ...
                <label className="focus-within:ring-3 focus-within:ring-fitique-lilac mt-7 flex min-h-64 cursor-pointer flex-col items-center justify-center border border-dashed border-fitique-brown/60 bg-fitique-paper p-6 text-center hover:border-fitique-plum">
                  <ImageUp size={32} className="text-fitique-plum" />
              ...
              <label className="mt-5 flex items-start gap-3 text-xs leading-5 text-fitique-ink/65">
                ...
                />{" "}
                I consent to Fitique using this photo for my fit analysis and
                storing it with my saved result.
              </label>
              {errors.consent && (
                <p role="alert" className="field-error">
              ...
              <div className="mt-7 flex justify-end">
                <button onClick={next} className="plum-button focus-ring">
          ...
          {step === 2 && (
            <section className="mx-auto max-w-3xl">
              <p className="eyebrow text-fitique-brown">Step 02</p>
              <h2 className="serif mt-2 text-4xl text-fitique-plum">
                What are you considering?
              </h2>
              <p className="mt-3 text-sm leading-6 text-fitique-ink/65">
                Pick a piece to receive guidance against its available sizes.
              </p>
          ...
          {step === 3 && (
            <section className="mx-auto max-w-3xl">
              <p className="eyebrow text-fitique-brown">Step 03</p>
              <h2 className="serif mt-2 text-4xl text-fitique-plum">
                Make it yours.
              </h2>
              <p className="mt-3 text-sm leading-6 text-fitique-ink/65">
                Add optional styling extras and, if you wish, save the
                preferences that make your next Fit Check feel more personal.
              </p>
              ...
              <form
                onSubmit={profileForm.handleSubmit(saveCurrentProfile)}
              ...
              >
                <div className="flex items-baseline justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-6 text-fitique-ink/65">
                      Optional profile details support a more considered
                      recommendation. You can change them any time.
                    </p>
                  </div>
                  {isAuthenticated && (
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-2">
                  <input
                    ...
                    {...profileForm.register("preferredSize")}
                  />
                  <input
                    className="field-input text-sm"
                  ...
                  <input
                    ...
                    {...profileForm.register("stylePreferences")}
                  />
                </div>
                <textarea
          ...
          {step === 4 && (
            <section className="mx-auto grid max-w-xl place-items-center py-20 text-center">
              ...
              <p className="mt-3 max-w-md text-sm leading-6 text-fitique-ink/65">
                Considering the visual context, the piece you selected, and your
                saved preferences. This usually takes a few moments.
              </p>
            </section>
          )}
          {step === 5 && result && (
              ...
              <div className="grid gap-7 lg:grid-cols-[.88fr_1fr] lg:items-center">
                ...
                <div>
                  ...
                  <h2 className="serif mt-2 text-5xl leading-none text-fitique-plum">
                    Try a size <i>{result.recommendedSize}.</i>
                  </h2>
                  ...
                  <div className="mt-6 border-t border-fitique-line pt-5">
                    <p className="field-label">Stylist note</p>
                    ...
                    <button
                      onClick={() => {
                        if (selectedProduct) {
                          ...
                          toast("Your selected piece is in the bag");
                        }
                      }}
                      className="plum-button focus-ring"
                    >
                      <ShoppingBag size={15} /> Add piece to bag
                    </button>
                    <button
                      onClick={() =>
                        toast(
