...
const ProductDetails = lazy(
  () => import("./features/products/pages/product.Details.jsx"),
);

// # commerce relaed
const Cart = lazy(() => import("./features/commerce/pages/commerce.cart.jsx"));
const Checkout = lazy(
  () => import("./features/commerce/pages/commerce.checkout.jsx"),
);
const OrderConfirmation = lazy(
  () => import("./features/commerce/pages/commerce.orderConfirmation.jsx"),
);
const Orders = lazy(
  () => import("./features/commerce/pages/commerce.orders.jsx"),
);
const OrderDetails = lazy(
  () => import("./features/commerce/pages/commerce.orderDetails.jsx"),
);
...
const FitHistory = lazy(
  () => import("./features/user/pages/user.fitHistory.jsx"),
);
